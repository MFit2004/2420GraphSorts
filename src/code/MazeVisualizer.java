...
/**
 * MazeVisualizer generates Graphics that show a graph, 
 * @description all display functionality
 * @author Omer_Khalid + Trevor_Austin + Matthew_Fitzgerald  
 * @course CS-2420-001 Algorithms & Data Structures Fall 2025
 * @last modified December 6, 2025
 * @assignment Team Project: Algorithm Racing
 */
...
public class MazeVisualizer extends JPanel {
	...
	/**
	* layout, timers, initialize graphs
	* @param mazeGraph overall graph/graph environment
	*/
